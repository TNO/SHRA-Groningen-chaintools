...
class IntegrationTests(TestCase):
    ...
    test_config = {
        ...
        "dimensions": {
            ...
            "dimension_3": {"length": 10},
            "dimension_4": {"length": 10},
        },
        "coordinates": {
            "dimension_3_alt": {
                "dim": "dimension_3",
    ...
    def test_configuration(self):
        ...
        # act
        # ---
        config = cfg.configure(self.test_config_file, default_task_name=task_name)
    ...
    def test_prepare_ds(self):
        ...
        # arrange
        # -------
        dataset_empty_expected = xr.load_dataset(
            "./tests/res/test_empty_dataset.h5", engine="h5netcdf"
        )
        #
        # act
        # ---
    ...
    @staticmethod
    def build_config_file_for_module(
        self, config: dict, dir: str, module: str, config_name: str = "temp_config.yml"
    ) -> str:
        """
